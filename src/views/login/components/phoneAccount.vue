<template>
    <div class="wrapper">
      ...
      <div class="inp border-bottom" :style="{opacity}">
        ...
        />
        <!-- 输入清空符号 -->
        <i v-show="isShow" class="phone el-icon-close" @click="clearInput"></i>
      </div>
...
<script>
// import {phoneRegistered} from '../../../networks/index.js'
...
export default {
  ...
  methods: {
     ...
     * @param {number} phone
     */
    _determineRegistered () {
      // let self = this
      phoneRegistered({phone:this.phone})
      .then(res => {
